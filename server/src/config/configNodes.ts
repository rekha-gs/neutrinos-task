export default {
    "db-config": {
        "sd_0DFdrBziU26BWJ82": {
            ...
            "users": {
                "SSD_SERVICE_ID_sd_PbQCHX12RA8RKugW": [
                    "sd_VDD8BFVcleIiX75f"
                ]
            }
        },
        "sd_pafuTdZXQrktWyou": {
            "id": "sd_pafuTdZXQrktWyou",
            "type": "db-config",
            "viewType": "common",
            "nodeType": "flow",
            "dbOption": {
            ...
            "mongodb_url": "mongodb://localhost:27017/mylib",
            "mongodb_options": "",
            "mysql_name": "mysql_0",
            "mysql_type": "mysql",
            "mysql_host": "localhost",
            ...
            "__ssdTypeInputs__": {
                ...
                "mongodb_url": {
                    "type": "str",
                    "value": "mongodb://localhost:27017/mylib"
                },
                "mongodb_options": {
                    "type": "str",
                    "value": ""
            ...
            "__n_excludedFromValidation__": {},
            "users": {
                "SSD_SERVICE_ID_sd_23XMnLTbgDwVKr1w": [
                    "sd_W07SkmbSSn1Psdse"
                ]
            }
        }
